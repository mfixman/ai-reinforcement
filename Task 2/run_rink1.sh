...
#SBATCH --error rink_1.err
#SBATCH --output rink_1.out
...
python rink.py --method TargetNetwork --hidden_size 512 --lr 0.001 --gamma 0.99 --eps_start 0.5
python rink.py --method DDQN --hidden_size 512 --lr 0.001 --gamma 0.99 --eps_start 1
