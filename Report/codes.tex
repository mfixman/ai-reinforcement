...
\lstinputlisting[title=Pong.py]{../Individual Task/Pong.py}

\subsection{Extra Task}
\lstinputlisting[title=Agents]{../Task 3/Agents.py}
\lstinputlisting[title=SpaceInvaders.py]{../Task 3/SpaceInvaders.py}
\lstinputlisting[title=models.py]{../Task 3/models.py}
\lstinputlisting[title=replay.py]{../Task 3/replay.py}
\lstinputlisting[title=utils.py]{../Task 3/utils.py}
% \subsection{}